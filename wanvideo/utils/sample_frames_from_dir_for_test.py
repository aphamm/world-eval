...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Process HDF5 files and extract frames"
    )
    parser.add_argument(
        "--input", required=True, help="Input directory containing HDF5 files"
    )
    parser.add_argument(
        "--output", required=True, help="Output directory for images and metadata"
    )
